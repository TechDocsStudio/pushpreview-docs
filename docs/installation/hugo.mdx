...
Here's a step-by-step guide to help you install PushPreview in your Hugo project.
...
To set up the PushPreview workflow in your Hugo project:

1. Go to the `.github/workflows` directory in your Hugo repository.
...
1. Modify the **Build site step** to align with your Hugo build process. For example:
...
1. Ensure the `source-directory` in the **Generate preview** step points to your Hugo build output folder, typically `./public`:
